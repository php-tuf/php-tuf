...
abstract class UpdaterTest extends TestCase
{
    ...
    public function testMetadataFileTooBig(string $fixtureName, string $authorityFile, string $fileToChange): void
    {
        ...
        $authorityData = file_get_contents(static::getFixturePath($fixtureName, "server/metadata/$authorityFile", false));
        $authorityData = json_decode($authorityData, true);
        ...
        $this->serverStorage->set($fileToChange, str_repeat('a', $knownLength + 1));
