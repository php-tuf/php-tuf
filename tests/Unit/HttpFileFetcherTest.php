...
/**
 * @coversDefaultClass \Tuf\Client\HttpFileFetcher
 */
class HttpFileFetcherTest extends TestCase
{
	/**
	 ...
	 *
	 * @return \Tuf\Client\HttpFileFetcher
	...
	public function testFetchMetadataReturnsCorrectResponseOnSuccessfulFetch(): void
	{
		...
		$this->assertSame(
			$this->testContent,
			$this->getFetcher($clientMock)->fetchMetadata('test.json', 256)->getContents()
		);
	}
